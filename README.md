...
Aplicação criada com ajuda do CHATGPT e testada em OCP 4.18 + ACM 3.13
...
Eu utilizo aquela configuração na VM para que ela vá para a BIOS na inicialização, isso dá o tempo necessário para a montagem manual da ISO após o comando de inciialização da VM feito pela iBMC
